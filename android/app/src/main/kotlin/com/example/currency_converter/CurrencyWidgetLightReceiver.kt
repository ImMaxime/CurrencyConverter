...
class CurrencyWidgetLightReceiver : HomeWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        appWidgetIds.forEach { widgetId ->
            ...
            val small = buildRemoteViews(context, R.layout.currency_widget_light_small,
                fromCurrency, toCurrency, rate, lastUpdated, rateLabel,
                rate10, rate50, rate100, rate250, pendingIntent)
            val medium = buildRemoteViews(context, R.layout.currency_widget_light_layout,
                fromCurrency, toCurrency, rate, lastUpdated, rateLabel,
                rate10, rate50, rate100, rate250, pendingIntent)
            val wide = buildRemoteViews(context, R.layout.currency_widget_light_wide,
                fromCurrency, toCurrency, rate, lastUpdated, rateLabel,
                rate10, rate50, rate100, rate250, pendingIntent)
